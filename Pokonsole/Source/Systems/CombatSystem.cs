                ...
                while (pokemon1.IsKnockOut == false && pokemon2.IsKnockOut == false)
                {
                    ...
                    else //IA Turn
                    {
                        ...
                        if (pokemon2.IsWild == false)
                        {
                            ...
                            UseAbility(pokemon2, pokemon1, pokemon1.GetCapacity(randomIAMove.Next(1, 4)));
                            Console.WriteLine(pokemon2 + " a utilisé" + pokemon1.GetCapacity(randomIAMove.Next(1, 4)).Name + " sur " + pokemon1);
                        }
                        else 
                        {
                            var randomIAMove = new Random();
            ...
            else if (capacity.AttackMissed != true)
            {
                if (target == attacker)
                {
                    if (capacity.Name == "Danse Lame")
                    {
                        ...
                        Console.WriteLine( attacker.Name + " has increased his attack up to " + target.Attack);
                    }
                    if (capacity.Name == "nomDefenseBuff")
                    {
                        capacity.DefenseBuff(target);
                        Console.WriteLine(attacker.Name + " has increased his defense up to " + target.Defense);
                    }
                    if (capacity.Name == "nomAttackSpeBuff")
                    {
                        capacity.AttackSpeBuff(target);
                        Console.WriteLine(attacker.Name + " has increased his special attack up to " + target.SpecialAttack);
                    }
                    if (capacity.Name == "nomDefenseSpeBuff")
                    {
                        capacity.DefenseSpeBuff(target);
                        Console.WriteLine(attacker.Name + " has increased his special defense up to " + target.SpecialDefense);
                    }
                }
                else
                {
